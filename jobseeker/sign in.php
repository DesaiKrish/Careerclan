...
<center>
 <div style="margin:50px;">
  ...
  <a href="../index.php"><img src="../images/favicon.jpg" alt="favicon" style="width: 100px; height: 100px;"></a>
    ...
    <fieldset>
            <legend style="font-size:20px;text-align:center">Applicant sign in</legend>
      <?php
      if (isset($_GET['error'])) {
      $error = $_GET['error'];
    ...
    <input type="text"  id="username" name="username" placeholder="username">
      ...
      <div class="row">
          <div class="col-xs-7">
          already have an account? <a href="jobseeker_login.php">login</a>
          </div>
          <div class="col-xs-4">
...
if (mysqli_num_rows($result) > 0) {
   header("location:sign in.php?error=username is already taken,please choose another username");
}
elseif (mysqli_num_rows($run) > 0) {
  ...
  $query = "INSERT INTO `login` (`email`, `password`, `username`) VALUES ('$email', '$password1','$username1')";
